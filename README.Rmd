...
　  
なお、不明点などは [データ分析勉強 <i class="fa fa-external-link"></i>](https://sites.google.com/site/kantometrics/home){target="_blank" title="Google site"} まで、または、本リポジトリのissues にて問い合わせください。  
　  
